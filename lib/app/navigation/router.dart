...
import 'package:smart_car/pages/live_data/ui/all_pids_page.dart';
...
import 'package:smart_car/pages/data_logs/data_logs_page.dart';
import 'package:smart_car/pages/saved_trips/saved_trips_page.dart';
...
abstract class AppRouter {
  ...
  static Route<Object>? generate(RouteSettings settings) {
    return Platform.isIOS
        ? CupertinoPageRoute(builder: (_) => settings.page, settings: settings)
        : MaterialPageRoute(builder: (_) => settings.page, settings: settings);
  }
}
...
extension on RouteSettings {
  Widget get page {
    switch (name) {
      ...
      case SharedRoutes.allPids:
        return const AllPidsPage();
      ...
      case SharedRoutes.dataLogs:
        return const DataLogsPage();
      case SharedRoutes.savedTrips:
        return const SavedTripsPage();
      default:
        return const App();
    }
  }
